...
class DependencySyncError(Exception):
    ...
    for storing error context including file paths and formatted error messages.
    ...
    Example:
        >>> try:
        ...     raise DependencySyncError("Something went wrong", "/path/to/file.toml")
        ... except DependencySyncError as e:
...
class TOMLParsingError(DependencySyncError):
    ...
    Example:
        ...
        ...     )
        ... except TOMLParsingError as e:
        ...     print(e)  # "Invalid TOML syntax (file: pyproject.toml) (line: 15)"
    """
...
class VersionConstraintError(DependencySyncError):
    ...
    Attributes:
        ...
        dependency (str, optional): Name of the dependency with the problematic constraint
    ...
    Example:
        ...
        ...     print(e)  # "Invalid constraint format (dependency: fastapi, constraint: invalid-constraint)"
    """
    
    def __init__(self, message: str, dependency: str = None, constraint: str = None) -> None:
        """
    ...
    def __str__(self) -> str:
        if self.dependency and self.constraint:
            return f"{self.message} (dependency: {self.dependency}, constraint: {self.constraint})"
...
class DockerfileUpdateError(DependencySyncError):
    ...
    Example:
        ...
        ...     print(e)  # "Could not find pip install block (file: Dockerfile) (backup: Dockerfile.backup_20240101_120000)"
    """
    
    def __init__(self, message: str, dockerfile_path: str = None, backup_path: str = None) -> None:
        """
